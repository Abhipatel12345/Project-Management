    ...
    <div className={cn('flex items-center gap-2', className)}>
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className="flex items-center gap-1 px-3 py-1.5 rounded-xl bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border border-emerald-200 text-xs font-bold transition cursor-pointer"
        ...
        <button
          ...
          className="p-1.5 rounded-xl bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 transition cursor-pointer shadow-xs"
          ...
          <div className="relative w-full max-w-lg bg-white border border-slate-200 rounded-3xl p-6 space-y-4 shadow-2xl">
            ...
            <div className="space-y-3">
              ...
              <div
                ...
                className="p-8 border-2 border-dashed border-slate-300 hover:border-sky-500 rounded-2xl text-center space-y-2 cursor-pointer bg-slate-50 transition"
              >
